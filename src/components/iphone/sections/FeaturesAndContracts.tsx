      ...
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100/20 p-6 md:p-8">
          ...
          <PageText className="text-gray-600">
            ...
            <Link to="/samsung-mobile-phones" className="text-primary hover:underline">Samsung phone contracts</Link> or{" "}
            <Link to="/google-mobile-phones" className="text-primary hover:underline">Google phone contracts</Link> if you're curious about what the competition offers. And for those who love a bargain, don't overlook opportunities like{" "}
