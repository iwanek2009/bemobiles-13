      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 items-center">
            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid grid-cols-3 gap-6 p-6 w-[800px] absolute left-1/2 -translate-x-1/2 bg-white rounded-lg shadow-lg">
            ...
            <Link to="#" className="text-I'll help fix the mega menu positioning to ensure it opens in the center of the page. Let's modify the Header component to adjust the positioning.

<lov-code>
Let's update the Header.tsx file to improve the mega menu positioning:
            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid grid-cols-3 gap-6 p-6 w-[800px] absolute left-1/2 -translate-x-1/2 bg-white">
                      {/* Mobile Phones Column */}
                      <div>
                        <h3 className="font-semibold mb-3">Mobile Phones</h3>
                        <div className="space-y-2">
