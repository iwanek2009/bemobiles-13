  ...
  return (
    ...
    >
      <CollapsibleTrigger asChild>
        ...
        >
          <span className="text-left font-normal pr-8 leading-tight">{question}</span>
          <ChevronDown
      ...
      <CollapsibleContent className="bg-white p-4 text-base md:text-lg border-x border-b border-gray-200 rounded-b-md">
        {answer}
      </CollapsibleContent>
    </Collapsible>
  );
