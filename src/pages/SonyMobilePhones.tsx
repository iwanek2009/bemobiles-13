      ...
      <div className="container mx-auto px-4 py-12 max-w-[800px]">
        <div className="space-y-8">
          <section>
            ...
            <PageText>
              If you're on the hunt for a new smartphone deal in the UK, you might already be eyeing the latest from major brands like Apple, Google, and Samsung. But before you decide, take a moment to explore what Sony has to offer.
            </PageText>
            <PageText>
