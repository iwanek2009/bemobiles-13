...
const BestMobilePhoneDealsSouthampton = () => {
  ...
  return <>
      <TheMobile title="Best Mobile Phone Deals in Southampton" description="Compare the latest phone contracts and exclusive deals available in Southampton. Find great value plans from all major networks with flexible monthly payments and data options." heroImage="/lovable-uploads/7957768e-94f3-4f05-b4fc-1c67cb7ddeab.png" imageAlt="Latest smartphones available in Southampton" filter={{
      upfront_price: {
        min: 0,
        max: 0
      }
    }} sort="POPULARITY" imageProps={{
      loading: "eager",
      fetchPriority: "high",
      width: "800",
      height: "800",
